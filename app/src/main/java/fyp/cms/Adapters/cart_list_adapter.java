...
public class cart_list_adapter extends RecyclerView.Adapter<cart_list_adapter.cart_list_viewholder> {
    ...
    public cart_list_adapter(ArrayList<cartItems> cartItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull final cart_list_viewholder holder, final int position) {
        holder.productName.setText(cartItems.get(position).getName()+" "+"("+cartItems.get(position).getGender()+")");
        ...
        holder.removeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rows > 0) {
                    ...
                    Toast.makeText(context,"Animal not Removed From Cart", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
