...
public class Selection extends AppCompatActivity {
        ...
        if(prefs.getString("user_info",null)!=null){
            ...
            if(u!=null){
                if(u.getRole().equals("Seller")){
                    startActivity(new Intent(Selection.this,sellar_home_page.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP));
                    finish();
                }else{
                    startActivity(new Intent(Selection.this,buyer_home_page.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP));
                    finish();
                }
            }
    ...
    private void openRegisterDialog(){
        ...
        final MaterialEditText name=registerView.findViewById(R.id.nametxt);
        final MaterialEditText email=registerView.findViewById(R.id.emailtxt);
        final MaterialEditText phone=registerView.findViewById(R.id.phonetxt);
        final MaterialEditText password=registerView.findViewById(R.id.passwordtxt);
        final MaterialEditText accountNo=registerView.findViewById(R.id.accountNo);
        final MaterialSpinner roles=registerView.findViewById(R.id.role);
        ...
        final AlertDialog registerDialog=new AlertDialog.Builder(Selection.this)
                .setTitle("Register")
        ...
        registerDialog.getButton(BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(accountNo.getVisibility()==View.VISIBLE&&accountNo.getText().toString().isEmpty()){
                    accountNo.setError("Enter Account Number");
                }else{
                    if(utils.isNetworkAvailable(Selection.this)) {
                        if(accountNo.getVisibility()==View.VISIBLE) {
                            firebase_operations.Register(name.getText().toString(), email.getText().toString(), password.getText().toString(), phone.getText().toString(), roles.getSelectedItem().toString(), Selection.this, registerDialog, accountNo.getText().toString());
                        }else{
                            firebase_operations.Register(name.getText().toString(), email.getText().toString(), password.getText().toString(), phone.getText().toString(), roles.getSelectedItem().toString(), Selection.this, registerDialog,null);
                        }
                    }else{
    ...
    private void openLoginDialog(){
        ...
        final MaterialEditText email=loginView.findViewById(R.id.emailtxt);
        final MaterialEditText password=loginView.findViewById(R.id.passwordtxt);
        final AlertDialog loginDialog=new AlertDialog.Builder(Selection.this)
                .setTitle("Sign In")
    ...
    private void openForgotPasswordDialog(){
        ...
        final MaterialEditText email=forgotPasswordView.findViewById(R.id.emailtxt);
        final AlertDialog forgotPasswordDialog=new AlertDialog.Builder(Selection.this)
