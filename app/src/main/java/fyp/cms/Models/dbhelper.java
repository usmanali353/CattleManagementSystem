...
public class dbhelper extends SQLiteOpenHelper {
    ...
    String[] columns={"id","productname","price","image","quantity","userId","productid","weight","gender","sellerId","sellerAccountNo"};
    String creat_table="create table shoppingcart (id integer primary key autoincrement,productname text,price integer,image blob,quantity integer,userId text,productid text,weight text,gender text,sellerId text,sellerAccountNo text);";
    ...
    public Boolean insert_product_toshoppingcart(String productname, int price, byte[] image, int quantity, String Username, String productid, String weight,String age,String sellerId,String sellerAccountNo){
        ...
        cv.put("sellerAccountNo",sellerAccountNo);
